...
TFR00SH = Class(CWallStructureUnit) {

  OnStopBeingBuilt = function(self)
    local x,y,z = unpack(self:GetPosition())

    TerraFormerT1.Slope(x+2,z+2,12,2, self);
    TerraFormerT1.Slope(x-1,z-1,12,2, self);
    TerraFormerT1.Slope(x-1,z+2,12,2, self);
    TerraFormerT1.Slope(x+2,z-1,12,2, self);
    self:Destroy()
