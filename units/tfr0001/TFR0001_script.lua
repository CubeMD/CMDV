...
TFR0001 = Class(CWallStructureUnit) {

  OnStopBeingBuilt = function(self)
    local x,y,z = unpack(self:GetPosition())

    TerraFormerT1.FlattenTerrain(x+2,z+2,2, self);
    TerraFormerT1.FlattenTerrain(x-1,z-1,2, self);
    TerraFormerT1.FlattenTerrain(x-1,z+2,2, self);
    TerraFormerT1.FlattenTerrain(x+2,z-1,2, self);
    self:Destroy()
