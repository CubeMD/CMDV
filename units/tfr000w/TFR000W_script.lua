...
TFR000W = Class(CWallStructureUnit) {

  OnStopBeingBuilt = function(self)
    local x,y,z = unpack(self:GetPosition())

    TerraFormerT1.FlattenTerrain(x+2,z+2,-4, self);
    TerraFormerT1.FlattenTerrain(x-1,z-1,-4, self);
    TerraFormerT1.FlattenTerrain(x-1,z+2,-4, self);
    TerraFormerT1.FlattenTerrain(x+2,z-1,-4, self);
    self:Destroy()
